  ...
  if (localStorage.getItem("userName")) {
    nameElement.textContent = `Hello, ${localStorage.getItem("userName").toLocaleUpperCase()}`;
  } else {  
  ...
  document.querySelector(".submit").addEventListener("click", async () => {
    ...
    document.querySelector(".answer1").innerHTML = ` <div class="question">
            <img src="https://lh3.googleusercontent.com/ogw/AF2bZyiYs974rr3rsci12HnaS6I3xuk5IlWABRWYMnRYkcNp7w=s32-c-mo" alt="" /> ${document.querySelector(".textarea").innerHTML}</div>`;
